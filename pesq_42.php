 ...
 <span><strong>PESQUISA POR ESTAÇÃO</strong></span><br><br><br>
  ...
  <form class="form-inline" role="form"   method="POST" action="pesq_42.php" style="margin-left:10%;">
    <div class="form-group">
     ...
     $sql = mysql_query ("select * from anuf where anuf = '42' group by cabo_rota" );
...
$sql = mysql_query ("select * from anuf where cabo_rota = '$estacao'   and anuf = '42' order by porta asc" );
$sql2 = mysql_query ("select * from anuf where cabo_rota = '$estacao'   and anuf = '42' order by porta asc" );
...
if($sql && $sql2 )
{
  ...
  echo '<meta HTTP-EQUIV="Refresh" CONTENT="3;URL=pesq_42.php?estacao='.$cabo_rota.'">';
